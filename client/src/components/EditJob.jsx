...
const EditJob = () => {
  ...
  const getJob = async () => {
    try {
      const response = await fetch(
        `https://test-rho-five-19.vercel.app/job/${id}`
      );
  ...
  const editJob = async (e) => {
    ...
    try {
      ...
      await fetch(`https://test-rho-five-19.vercel.app/updateJob/${id}`, {
        method: "PATCH",
  ...
  const handleDelete = async () => {
    try {
      await fetch(`https://test-rho-five-19.vercel.app/deleteJob/${id}`, {
        method: "DELETE",
      });
